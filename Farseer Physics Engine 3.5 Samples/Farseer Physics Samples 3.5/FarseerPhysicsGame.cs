...
namespace FarseerPhysics.Samples
{
    ...
    public class FarseerPhysicsGame : Game
    {
        ...
        public FarseerPhysicsGame(string frameworkName = "")
        {
            Window.Title = frameworkName + "Farseer Samples Framework";
        ...
        protected override void Initialize()
        {
            ...
            menuScreen.AddMenuItem("", EntryType.Screen, new CameraTests());



            menuScreen.AddMenuItem("", EntryType.Screen, new RopeDemo());
            menuScreen.AddMenuItem("", EntryType.Screen, new AdvancedDemo2B());
            menuScreen.AddMenuItem("", EntryType.Screen, new AdvancedDemo5B());
            menuScreen.AddMenuItem("", EntryType.Screen, new GameDemo2());
