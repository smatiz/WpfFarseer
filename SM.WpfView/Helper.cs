...
namespace SM.WpfView
{
    ...
    {
        public static void LoadFarseer(string id, IEnumerable<IEntity> entities, Canvas rootCanvas, IContext context, out Info info, out Views views)
        {
            // prendo lo xaml e lo passo a Info che e' completamente agnostico
            info = new Info(id, entities);
